...
class StrategyLearner(object):
    ...
    def __init__(self, verbose=False, impact=0.0, commission=0.0, learner=BagLearner, leaf_size=5):
        ...
        self.learner = learner(learner=RTLearner, kwargs={'leaf_size': self.leaf_size}, bags=1, boost=False, verbose=self.verbose)
        self.train_x = None
        self.train_y = None
    ...
    def plt_data(self, port_vals_bchm_norm, port_vals_norm):
...
if __name__ == '__main__':
    ...
    # port_val_tos = compute_portvals(orders=portval_tos, start_val=100000, commission=9.95, impact=0.005)
    ...
    cum_ret, avg_daily_ret, std_daily_ret, sharpe_ratio = compute_optimized_portfolio_stats(port_val_sl['portval'])
    ...
    print("Final Portfolio Value: {}".format(port_val_sl['portval'][-1]))
    ...
    # port_val_tos_norm.rename(columns={'portval': 'Optimized Learner'}, inplace=True)
